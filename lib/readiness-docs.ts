...
export const scorekeeperWorkspaceFlow = [
  ...
  "Commands use idempotency keys and expected versions; scoring controls are online-only and stay blocked until the latest official state is confirmed after a disconnect.",
  "The console uses serverTime to display running clocks, records FIBA timeouts as append-only events, and never stores unconfirmed scoring changes on the device.",
