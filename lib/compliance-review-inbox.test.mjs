...
const organizerScreenSource = readFileSync(
  new URL(
    "../components/organizations/compliance/division-compliance-screen.tsx",
    import.meta.url,
  ),
  "utf8",
);
const organizerBuilderSource = readFileSync(
  new URL(
    "../components/organizations/compliance/division-compliance-builder.tsx",
    import.meta.url,
  ),
  "utf8",
);
...
const reviewDetailSource = readFileSync(
  new URL(
    "../components/organizations/compliance/division-compliance-review-detail.tsx",
    import.meta.url,
  ),
  "utf8",
);
const reviewEvidenceSource = readFileSync(
  new URL(
    "../components/organizations/compliance/division-compliance-review-evidence.tsx",
    import.meta.url,
  ),
  "utf8",
);
const reviewDecisionSource = readFileSync(
  new URL(
    "../components/organizations/compliance/division-compliance-review-decision.tsx",
    import.meta.url,
  ),
  "utf8",
);
const reviewHistorySource = readFileSync(
  new URL(
    "../components/organizations/compliance/division-compliance-review-history.tsx",
    import.meta.url,
  ),
  "utf8",
);
const reviewRouteUrl = new URL(
  "../app/organizations/[slug]/divisions/[divisionId]/requirements/reviews/[submissionId]/page.tsx",
  import.meta.url,
);
const reviewRouteEnabled = existsSync(reviewRouteUrl);
const reviewRouteSource = reviewRouteEnabled
  ? readFileSync(reviewRouteUrl, "utf8")
  : "";
const managerContentSource = readFileSync(
  new URL(
    "../components/organizations/compliance/manager-compliance-content.tsx",
    import.meta.url,
  ),
  "utf8",
);
const managerRequirementSource = readFileSync(
  new URL(
    "../components/organizations/compliance/manager-compliance-requirement.tsx",
    import.meta.url,
  ),
  "utf8",
);
const managerSummarySource = readFileSync(
  new URL(
    "../components/organizations/compliance/manager-compliance-summary.tsx",
    import.meta.url,
  ),
  "utf8",
);
const managerHistorySource = readFileSync(
  new URL(
    "../components/organizations/compliance/manager-compliance-history.tsx",
    import.meta.url,
  ),
  "utf8",
);
...
test("checklist settings use a focused workspace hierarchy", () => {
  ...
  assert.match(
    organizerBuilderSource,
    /Published changes apply to new submissions/,
  );
...
test("admin review previews verified evidence inside Swish", () => {
  ...
  assert.match(reviewEvidenceSource, /<(?:Image|img)/);
...
test(
  "dedicated review routing preserves direct links and has no drawer",
  {
    skip:
      !reviewRouteEnabled && "Compliance review routes are parked for the MVP.",
  },
  () => {
...
test("manager submission uses one atomic request and saves completed uploads", () => {
  ...
  const uploadStart = managerContentSource.indexOf(
  ...
  assert.match(
    managerContentSource,
    /savingId === requirement\.requirement_id/,
  );
  assert.match(
    complianceServiceSource,
